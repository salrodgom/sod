...
MODULE mc_sampler
    ...
    REAL(dp), PRIVATE :: r  ! Random number
    ...
    SUBROUTINE update_properties(properties)
        IMPLICIT NONE
        REAL(dp), INTENT(INOUT) :: properties(:)
        ! Update ensemble averages here
        properties(1) = properties(1) + current_energy
